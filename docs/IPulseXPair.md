...
```solidity
function burn(address to, address senderOrigin) external nonpayable returns (uint256 amount0, uint256 amount1)
```
...
| senderOrigin | address | undefined |
...
```solidity
function mint(address to, address senderOrigin) external nonpayable returns (uint256 liquidity)
```
...
```solidity
event Burn(address indexed sender, uint256 amount0, uint256 amount1, address indexed to, address indexed senderOrigin)
```
...
| senderOrigin `indexed` | address | undefined |

### Mint

```solidity
event Mint(address indexed sender, uint256 amount0, uint256 amount1, address indexed senderOrigin)
```
